...
const MediaMarktPlSite = require('../../../lib/sites/media-markt-pl');

const VALID_URI = 'http://mediamarkt.pl/123/product';
const INVALID_URI = 'http://www.bad.com/123/product';

describe('The MediaMarktPl Site', () => {
  it('should exist', () => {
    should.exist(MediaMarktPlSite);
  });

  describe('isSite() function', () => {
    it('should return true for a correct site', () => {
      should(MediaMarktPlSite.isSite(VALID_URI)).be.true();
    });

    it('should return false for a bad site', () => {
      should(MediaMarktPlSite.isSite(INVALID_URI)).be.false();
    });
  });
  ...
  it('should throw an exception trying to create a new site with an incorrect uri', () => {
    should.throws(() => {
      ...
      new MediaMarktPlSite(INVALID_URI);
      /* eslint-enable no-new */
    });
  });

  describe('a new MediaMarktPl Site', () => {
    let site;

    beforeEach(() => {
      site = new MediaMarktPlSite(VALID_URI);
    });
