...
const KomputronikSite = require('../../../lib/sites/komputronik');

const VALID_URI = 'http://komputronik.pl/123/product';
const INVALID_URI = 'http://www.bad.com/123/product';

describe('The Komputronik Site', () => {
  it('should exist', () => {
    should.exist(KomputronikSite);
  });

  describe('isSite() function', () => {
    it('should return true for a correct site', () => {
      should(KomputronikSite.isSite(VALID_URI)).be.true();
    });

    it('should return false for a bad site', () => {
      should(KomputronikSite.isSite(INVALID_URI)).be.false();
    });
  });
  ...
  it('should throw an exception trying to create a new site with an incorrect uri', () => {
    should.throws(() => {
      ...
      new KomputronikSite(INVALID_URI);
      /* eslint-enable no-new */
    });
  });

  describe('a new Komputronik Site', () => {
    let site;

    beforeEach(() => {
      site = new KomputronikSite(VALID_URI);
    });
