...
const EuroComSite = require('../../../lib/sites/euro-com');

const VALID_URI = 'http://euro.com.pl/123/product';
const INVALID_URI = 'http://www.bad.com/123/product';

describe('The EuroCom Site', () => {
  it('should exist', () => {
    should.exist(EuroComSite);
  });

  describe('isSite() function', () => {
    it('should return true for a correct site', () => {
      should(EuroComSite.isSite(VALID_URI)).be.true();
    });

    it('should return false for a bad site', () => {
      should(EuroComSite.isSite(INVALID_URI)).be.false();
    });
  });
  ...
  it('should throw an exception trying to create a new site with an incorrect uri', () => {
    should.throws(() => {
      ...
      new EuroComSite(INVALID_URI);
      /* eslint-enable no-new */
    });
  });

  describe('a new EuroCom Site', () => {
    let site;

    beforeEach(() => {
      site = new EuroComSite(VALID_URI);
    });
